                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="apellidoP" value="{{$usuario->apellidoP}}" placeholder="Apellido Paterno">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="acc-mname">Apellido Materno</label>
                                        <input type="text" class="form-control"  name="apellidoM" value="{{$usuario->apellidoM}}" placeholder="Apellidos completos">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label >Usuario</label>
                                        <input type="text" class="form-control" name="username" value="{{$usuario->username}}" readonly placeholder="">
